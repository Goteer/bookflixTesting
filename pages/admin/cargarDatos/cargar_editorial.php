...
<div class="cuadro-listado">
	<form method="post" action="../../pages/navigation/nav.php">
      ...
      <tr>
				<td>&nbsp;</td>
				<td><input type="hidden" name="target_page"  value="/pages/admin/cargarDatos/class/carga_editorial.php"/>
        <a onclick="this.parentNode.submit();"><button>Ingresar editorial</button></a></td>
			</tr>
		</table>
	</form>
</div>
