...
$trailers->setOtros("ORDER BY fecha DESC LIMIT ".$trailersPorPagina." OFFSET ".$page*$trailersPorPagina);
...
<?php
$hay = false;
while ($next = $trailers->getNextRecord()){
  $hay = true;
  ...
  <div class="row no-margin" style="padding-top:10px;padding-bottom:10px">
    ...
    <div class="col-md-2">
      <form method="post" action="../navigation/nav.php">
				...
				<input type="hidden" name="target_page" value="/pages/detalleTrailer/verTrailer.php"/>
...
<div class="nav-arrows">
  <?php if ($page > 0){ ?>
    <form style="display:inline;" method="post" action="../navigation/nav.php">
      <input type="hidden" name="target_page" value="/pages/detalleTrailer/listar_trailer_sub.php"/>
