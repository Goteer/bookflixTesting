...
#suscriptor input[type=submit], #suscriptor button {
...
<br>
  ...
  <label>Email:</label> <input type="email" required name="email" value="<?= (isset($_POST['email']))?$_POST['email']:$valoresUser['email'] ?>"/><br>


  <input type="hidden" name="target_page" value="/pages/administrarCuenta/class/cambiarEmail.php"/>
  <input type="submit" value="Cambiar correo electr&oacute;nico">
  </form>
</div>
